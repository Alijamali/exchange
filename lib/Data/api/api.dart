...
class DataUrl {
  ...
  dynamic callRegisterApi(name, email, password) async {
    ...
    final response = await Dio().post('https://besenior.ir/api/register', data: formData);
